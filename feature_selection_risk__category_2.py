...
omics1_3_poor.to_csv("/content/drive/MyDrive/omicData/aml_risk_category/gene_methy_separate normal_poor data/omic1/omics1_3_pValue_normal.csv",index=False)

data_omics1_3_poor_geneName = pd.read_csv("/content/drive/MyDrive/omicData/aml_risk_category/gene_methy_separate normal_poor data/omic1/omics1_3_pValue_normal.csv")
